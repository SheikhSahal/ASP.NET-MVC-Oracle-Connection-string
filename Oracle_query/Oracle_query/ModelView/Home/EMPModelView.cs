...
namespace Oracle_query.ModelView.Home
{
    ...
    {
        //string oradb = "Data Source=dbtest;User ID=psl;Password=psltest;";
        string oradb = "user id=psl;password=psltest;data source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.168.3.243)(PORT=1521))(CONNECT_DATA=(SID=PSLUAT)))";
